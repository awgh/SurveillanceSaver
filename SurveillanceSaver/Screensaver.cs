 ...
 *
 */
// cut down a bit and customized by awgh@awgh.org
#endregion
	...
	public abstract class Screensaver
	{
		...
		public void Run(ScreensaverMode mode)
		{
			...
			catch (FormatException)
			{
                ...
                //debug multiscreen
                //this.screensaverMode = ScreensaverMode.Normal;
			}
		...
		protected virtual void ShowSettingsDialog()
		{
			...
			MessageBox.Show(sw.ToString(), "SurveillanceSaver", MessageBoxButtons.OK);
		}
		...
		void InitializeAndStart()
		{
            ...
            {
                if (win != null && win.Form != null)
                    win.Form.FormClosing += new FormClosingEventHandler(Form_FormClosing);
            }
			StartUpdating();
		}
